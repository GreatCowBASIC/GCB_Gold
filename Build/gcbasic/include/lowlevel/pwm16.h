...
'    Copyright (C) 2017-2024  Peter Everett
...
#SCRIPT
  ...
  IF NODEF(USE_HPWM16_1) THEN
    USE_HPWM16_1=TRUE
  END IF
  IF NODEF(USE_HPWM16_2) THEN
    USE_HPWM16_2=TRUE
  END IF
  IF NODEF(USE_HPWM16_3) THEN
    USE_HPWM16_3=TRUE
  END IF
  IF NODEF(USE_HPWM16_4) THEN
    USE_HPWM16_4=TRUE
  END IF
  IF NODEF(USE_HPWM16_5) THEN
    USE_HPWM16_5=TRUE
  END IF
  IF NODEF(USE_HPWM16_6) THEN
    USE_HPWM16_6=TRUE
  END IF
  IF NODEF(USE_HPWM16_7) THEN
    USE_HPWM16_7=TRUE
  END IF
  IF NODEF(USE_HPWM16_8) THEN
    USE_HPWM16_8=TRUE
  END IF
  IF NODEF(USE_HPWM16_9) THEN
    USE_HPWM16_9=TRUE
  END IF
  IF NODEF(USE_HPWM16_10) THEN
    USE_HPWM16_10=TRUE
  END IF
  IF NODEF(USE_HPWM16_11) THEN
    USE_HPWM16_11=TRUE
  END IF
  IF NODEF(USE_HPWM16_12) THEN
    USE_HPWM16_12=TRUE
  END IF
