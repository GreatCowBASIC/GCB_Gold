'PIC-AS control
'This redirections are required as some common methods are reserved word in PIC-AS
...
Sub _Line(In LineX1 as word, In LineY1 as word, In LineX2 as word, In LineY2 as word, Optional In LineColour as Long = GLCDForeground)
