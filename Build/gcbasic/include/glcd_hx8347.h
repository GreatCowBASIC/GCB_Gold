...
'    Copyright (C) 2017-2026 Evan Venn and Kent Schafer
...
Sub GLCDCLS_HX8347 ( Optional In  GLCDBackground as word = GLCDBackground )
  ...
  Dim HX8347ReadWriteStatus as Bit
...
sub  SendCommand_HX8347( IN HX8347SendByte as word )
    ...
    #ifndef GLCD_HX8347_16bit
      If HX8347ReadWriteStatus = 0 Then GLCDSetWriteDir_HX8347
      HX8347_GLCD_CS = 0
      HX8347_GLCD_RS = 0
      HX8347_GLCD_RD = 1
