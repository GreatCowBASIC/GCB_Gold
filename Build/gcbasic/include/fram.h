...
'    Copyright (C) 2010-2024 Hugh Considine, Evan R. Venn and  Thomas Henry
...
'    24/08/22   Move user constants to script
...
#script
  ...
  IF NODEF(FRAM_DEVICE_1) THEN
      FRAM_DEVICE_1 = 0xAC  
  END IF

  IF NODEF(FRAM_CHIPS) THEN
      FRAM_CHIPS = 1  
  END IF
